...
Nesse projeto, o primeiro depois de comerçar a aprender JavaScript, o objetivo foi desenvolver um arquivo com diversas funções que realizassem o que foi pedido na especificação do projeto.

No mais, representou uma ótima oportunidade de começar a me habituar com a sintaxe do JavaScript, com a criação de um código limpo e com a lógica de programação, além da boa prática de dividir as tarefas sempre em blocos pequenos para fornecer maior modularidade e facilidade de manutenção do código.

_Repositório original do projeto: [tryber/sd-08-project-playground-function](https://github.com/tryber/sd-08-project-playground-function)_
